...
const Order = () => {
    ...
    const { cart, addToCart, oneMinusQty, clearCart, subTotal } = useContext(MyContext)
                            ...
                            <div className="container px-5 py-24 mx-auto">
                                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                                    <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                                        ...
                                        <p className="leading-relaxed mb-4">Fam locavore kickstarter distillery...</p>
                                    ...
                                    <div>
                                        <Image 
                                            height={500} 
                                            width={500} 
                                            alt={product.name}  // Update alt for accessibility
                                            className="lg:-1/2 ml-4 object-cover object-center rounded" 
                                            src="/product-1.webp" 
                                        />
                                    </div>
                                </div>
