                                ...
                                <div className="flex-[1] py-3">
                                    ...
                                    <div className='mb-10'>
                                        ...
                                        <div className='my-4 '>
                                            ...
                                            <form onSubmit={(e) => { e.preventDefault() }} className='mb-4 w-full' method="post">
                                                <div className="flex">
                                                    <input onChange={onChangePin} type="text" placeholder='Enter your Pincode' className='border px-3 sm:py-4 py-3 w-full rounded-3xl mr-2 border-gray-600' />
                                                    <button onClick={checkServiceAvailability} className='bg-black border border-black text-white sm:text-md text-sm px-auto py-3 w-full sm:py-4 rounded-3xl font-md transition-transform active:scale-95 hover:opacity-75'>Check</button>
                                                </div>
                                            </form>
